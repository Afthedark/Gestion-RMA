    ...
    <center style="background: white;" ><h1>VENTAS REGISTRADAS</h1></center>
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              $query= mysqli_query($conection,"SELECT id_venta,num_serie,fecha_venta,fecha_garantia,codigo_producto,estado FROM venta where estado in (1,2) order by id_venta asc
  ...
  <ul class="pagination justify-content-center"  >
    ...
    <?php 
      ...
      for ($i=1; $i <= $total_paginas; $i++) { 
        ...
        if($i==$pagina)
        {
          echo '<li class="page-item"  style="border: solid black;"><a class="page-link"  style="color: black;">'.$i."&nbsp;&nbsp;".'
             </a></li>';
        }else
        {
